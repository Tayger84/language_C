...
#include "kru_main.h" /* natazeni symbolickych konstant, funkcnich prototypu globalnich funkci a globalnich typu vlastniho modulu */
#include "kru_io.h" /* natazeni symbolickych konstant, funkcnich prototypu golbalnich funkci a globalnich typu spolupracujiciho modulu */
...
double vyp_prumer(double polomer) {
    return (2 * polomer);
}

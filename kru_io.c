...
#include "kru_io.h" /* natazeni symbolickych konstant, funkcnich prototypu globalnich funkci a globalnich typu vlastnich modulu */
#include "kru_main.h" /* natazeni symbolickych konstant, funkcnich prototypu globalnich funcki a globalnich typu spolupracujiciho modulu */

/* definice globalnich promennych */
 /* v tomto modulu zadne nejsou */

/* lokalni definice symbolickych konstat a maker */
